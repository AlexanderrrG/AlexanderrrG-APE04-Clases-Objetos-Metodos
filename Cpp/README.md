...
Puedes compilar y ejecutar este código utilizando IDEs como **Visual Studio Code** o **Code::Blocks**.

**Si usas la terminal con el compilador g++:**
1. Abre una terminal en esta carpeta.
2. Compila el código con el siguiente comando:
   ```bash
   g++ main.cpp -o sistema_estudiantes
